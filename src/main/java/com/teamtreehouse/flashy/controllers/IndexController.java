...
public class IndexController {
  ...
  private static final int AMOUNT_OF_CARDS_TO_SHOW = 3;
  ...
  public String index(Model model) {
    ...
    List<FlashCard> cards = flashCardService.getRandomFlashCards(AMOUNT_OF_CARDS_TO_SHOW);
    ...
    ctaBuilder.append(totalCount - AMOUNT_OF_CARDS_TO_SHOW);
